...
# 构建URL的基本部分
base_url = "https://github.com/meet-zzq/music/raw/main/musics/"  # 请将路径替换为实际的目录路径
base_lrc_url = "https://raw.githubusercontent.com/meet-zzq/music/main/musics/"  # 请将路径替换为实际的目录路径
# 获取目录中的所有文件名
file_names = [
    file
